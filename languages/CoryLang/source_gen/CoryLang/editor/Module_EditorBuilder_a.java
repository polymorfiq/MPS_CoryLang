...
/*package*/ class Module_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new statementsListHandler_iuuvkg_b1a(myNode, getEditorContext());
  ...
  private static class statementsListHandler_iuuvkg_b1a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public statementsListHandler_iuuvkg_b1a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.statements$E5QS;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.ModuleBodyElem$yD;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(statementsListHandler_iuuvkg_b1a.this.getNode(), LINKS.statements$E5QS));
      try {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SInterfaceConcept ModuleBodyElem$yD = MetaAdapterFactory.getInterfaceConcept(0xbe6061dd252a45b8L, 0x9db81233f2660809L, 0x39e7fc40f9b65bcbL, "CoryLang.structure.ModuleBodyElem");
  }
